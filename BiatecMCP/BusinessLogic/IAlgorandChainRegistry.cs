...
{
    /// <summary>
    /// The set of Algorand-family chains BiatecMCP can currently operate on - every chain in the public
    ...
    /// unreachable is not "supported" - see <see cref="AlgorandChainRegistry"/>.
    /// </summary>
